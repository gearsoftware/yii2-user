...
use gearsoftware\user\models\search\RoleSearch;
use Yii;
...
class RoleController extends BaseController
{
     ...
     * @var Role
     */
    public $modelClass = 'gearsoftware\models\Role';

    /**
     * @var RoleSearch
     */
    public $modelSearchClass = 'gearsoftware\user\models\search\RoleSearch';
    ...
    public function actionView($id)
    {
        ...
        $permissions = Permission::find()
            ->andWhere(Yii::$app->core->auth_item_table . '.name != :commonPermissionName',
                [':commonPermissionName' => Yii::$app->core->commonPermissionName])
            ->joinWith('group')
            ->all();
